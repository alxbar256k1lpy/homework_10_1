"""Модуль с функциями-генераторами для обработки банковских операций."""
...
def card_number_generator(start: int, stop: int) -> Generator[str, None, None]:
    """Генерирует 16-значные номера карт в заданном диапазоне с пробелами."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Генератор успешно завершил работу.")
